...
expect_equal(h$match_path("/test"), NULL)
expect_equal(h$match_path("/test1"), "1")
expect_equal(h$match_path("/test2"), NULL)
...
a = attr(h$match_path("/test2/1"), "path_parameters")
v = list("var1" = "1")
expect_equal(a, v)
a = attr(h$match_path("/test3/1/text/3"), "path_parameters")
