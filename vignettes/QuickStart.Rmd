...
It is generally a good idea to write unit tests against application. One can use a common framework such as [tinytest](https://cran.r-project.org/web/packages/tinytest/index.html).
