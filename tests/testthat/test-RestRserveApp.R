test_that("create RestRserveApp", {
  ...
  expect_error(app$add_endpoint(path = "/echo", method = "GET", FUN = function(request, ...) request$query[[1]]))
  ...
  expect_true(app$add_endpoint(path = "/echo", method = "GET", FUN = function(request) request$query[[1]]))
  ...
  expect_true(app$add_endpoint(path = "/echo", method = "HEAD", FUN = function(request) request$query[[1]]))
